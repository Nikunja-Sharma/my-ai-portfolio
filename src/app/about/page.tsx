  ...
  return (
    <section className="space-y-6">
      ...
      <section className="space-y-3">
        <H2>Welcome!</H2>
        <p>
          Hello! I{"'"}m Nikunja Sarma, a passionate self-taught web developer
          with a knack for creating engaging and dynamic web applications. My
          journey into the world of coding started with a curiosity about how
          websites worked, which quickly grew into a full-fledged passion.
          Through self-study and hands-on experience, I honed my technical
          skills and developed a deep understanding of cloud services and
          cybersecurity. I pursued a Bachelor of Computer Applications in Cloud
          Technology and Information Security at
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          introduced me to the vast world of{" "}
          <a
          ...
          . I worked on cloud deployment and infrastructure management projects,
          which gave me practical insights into cloud technology.
        </p>
        <hr className="border-muted" />
      </section>
      <section className="space-y-3">
        <p>
          ...
          ,
          <a href="https://shadcn.dev" className="text-primary hover:underline">
            {" Shadcn"}
          </a>
          ,
          <a
          ...
          ,
          <a href="https://stripe.com" className="text-primary hover:underline">
            {" Stripe"}
          </a>
          , and
          <a
          ...
          , I designed and developed a comprehensive event management
          application. This project allowed me to blend creativity with
          functionality, resulting in a tool that users find both intuitive and
          powerful.
        </p>
        <p>
          Another significant project is the{" "}
          <strong>IoT-Based Poultry Monitoring System</strong>, which I
          developed as part of my final year group project. This innovative
          solution leverages
          ...
          ,
          <a href="https://socket.io" className="text-primary hover:underline">
            {" Socket.IO"}
          </a>
          ,
          <a
          ...
          ,
          <a
            href="https://www.espressif.com/en/products/socs/nodemcu"
            className="text-primary hover:underline"
          >
            {" NodeMCU"}
          </a>
          ...
          , and more to monitor poultry conditions. This project not only
          showcased my technical skills but also highlighted my ability to work
          on interdisciplinary teams and tackle complex problems.
        </p>
        <hr className="border-muted" />
      </section>
      <section className="space-y-3">
        ...
        <p>
          Throughout my career, I have continuously sought to expand my skill
          set. I am proficient in front-end technologies like
          <a href="https://nextjs.org" className="text-primary hover:underline">
            {" Next.js"}
          </a>
          ,
          ...
          , and have a solid foundation in back-end development with
          <a href="https://nodejs.org" className="text-primary hover:underline">
            {" Node.js"}
          </a>
          ,
          ...
          . My database skills include working with
          <a
        ...
        <p>
          ...
          from Udemy and Teachnook, and an internship certificate from
          <a href="https://verzeo.in" className="text-primary hover:underline">
            Verzeo
          </a>
          . These certifications attest to my commitment to continuous learning
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          collaborating or just want to chat about technology, don{"’"}t
